...
# RPM
set(CPACK_RPM_BIN_FILE_NAME "${PROJECT_NAME}-bin-${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}-1.rpm")
set(CPACK_RPM_DEV_FILE_NAME "${PROJECT_NAME}-dev-${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}-1.rpm")
...
set(CPACK_RPM_DEV_PACKAGE_REQUIRES "${PROJECT_NAME}-bin = ${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}, protobuf >= 3.14.0, protobuf-devel >= 3.14.0, protobuf-compiler >= 3.14.0")
...
set(CPACK_DEBIAN_DEV_PACKAGE_DEPENDS "${PROJECT_NAME}-bin (=${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}), libprotobuf23 (>=3.12.4), libprotobuf23-dev (>=3.12.4), protobuf-compiler (>=3.12.4)")
